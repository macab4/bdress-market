...
export type NotificationType = 'new_listing' | 'offer_received' | 'offer_accepted' | 'offer_rejected' | 'offer_countered' | 'referral_bonus' | 'sale_paid' | 'label_requested' | 'withdrawal_requested'
